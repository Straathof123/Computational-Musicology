...
On this page, I have created a chordograph for the same song which I used for the spectogram, which is [Moonriver](https://www.youtube.com/watch?v=KhyyjRcrn84). For this chordograph, I have put the notes going down chromatically, instead of having them align with the circle of fiths. I've also made it so the yellow spots are the points that most align with what's going on in the song. 
